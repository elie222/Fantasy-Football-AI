...
class Game:
    ...
    def playGameweek(self,gameweekNo=None):
        ...
        self.currentTeam = self.agent.chooseTeam(self.currentAllPlayers, self.currentTable, self.previousTeam, self.moneyAvailable, self.freeTransfers, self.wildCards)
